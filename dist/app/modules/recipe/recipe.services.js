...
const myRecipeFromDb = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield recipe_model_1.Recipe.find({ author: userId });
    return result;
});
...
const deleteCommentFromDB = (recipeId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield recipe_model_1.Comment.deleteOne({ recipeId: recipeId });
    return result;
});
